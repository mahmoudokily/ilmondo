    ...
    return (
        <div >
            <div className={styles.sort_buttons}>
                ...
                <button className={styles.name} onClick={() => setValueAndDirection("name")} >
                    <div>
                        Name
                    </div>
                ...
                <button className={styles.area} onClick={() => setValueAndDirection("area")}>
                    <div>
                        area
                    </div>
                    {value === "area" && <RowOrder direction={direction} />}
                </button>
                <button className={styles.gini} onClick={() => setValueAndDirection("gini")}>
                    <div>
                        gini
                    </div>
